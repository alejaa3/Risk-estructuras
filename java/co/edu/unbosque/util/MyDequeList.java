...
public class MyDequeList<E> extends MyDoubleLinkedList<E> implements Dqueue<E>, Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8739772252858878387L;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MyDequeList<E> other = (MyDequeList<E>) obj;
		return size == other.size && Objects.equals(tail, other.tail);
	}
